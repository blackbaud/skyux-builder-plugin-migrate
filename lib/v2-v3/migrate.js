...
const stacheUtils = require('./stache');
...
async function writePackageJson(packageJson, isLib, dependencies, packageList) {
  ...
  dependencyUtils.fixDependencyOrder(packageJson.dependencies);
  dependencyUtils.fixDependencyOrder(packageJson.devDependencies);
  dependencyUtils.fixDependencyOrder(packageJson.peerDependencies);
