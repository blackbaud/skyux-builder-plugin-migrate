...
`
    ...
    mock('../../../lib/v2-v3/app-dependencies', appDependenciesMock);
    ...
    mock('../../../lib/v2-v3/tslint', tsLintMock);
    mock('../../../lib/v2-v3/webpack', webpackMock);
    mock('../../../lib/v2-v3/nvmrc', nvmrcMock);
    mock('../../../lib/v2-v3/gitignore', gitignoreMock);
    mock('../../../lib/cleanup', cleanupMock);
    mock('../../../lib/v2-v3/stache', stacheUtilsMock);

    migrate = mock.reRequire('../../../lib/v2-v3/migrate');
  });
...
`
    ...
    expect(skyuxConfigMock.updateSkyuxConfig).toHaveBeenCalledWith();
    expect(nvmrcMock.updateNvmrc).toHaveBeenCalledWith();
    expect(gitignoreMock.fixGitignore).toHaveBeenCalledWith();
  });
...
`
  ...
  it('should delete the package-lock.json file and node_modules folder', async () => {
    ...
    expect(cleanupMock.deleteDependencies).toHaveBeenCalledWith();
  });
...
`
  ...
  it('should rename deprecated stache tags and imports if stache SPA', async () => {
    ...
    expect(stacheUtilsMock.renameDeprecatedComponents).toHaveBeenCalledWith();
    expect(stacheUtilsMock.updateStacheImportPaths).toHaveBeenCalledWith();
  });
